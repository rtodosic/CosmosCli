...
public class ContainerDeleteParameters : BaseParameters
{
    ...
    public override void Apply(BaseParameters applyParams)
    {
        ...
        if (applyParams is ContainerDeleteParameters)
        {
            var containerParams = (ContainerDeleteParameters)applyParams;
            ...
            if (!string.IsNullOrWhiteSpace(containerParams.PartitionKey))
